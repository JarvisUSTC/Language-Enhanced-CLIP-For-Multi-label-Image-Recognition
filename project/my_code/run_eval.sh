...
do
    ...
    TEST.multi_scale "(2,3,4)" \
    TEST.use_freq True \
    TEST.save_pth True \
    TEST.save_name ./train_output/data_evidence.pth \
...
do
    ...
    TEST.multi_scale "(2,3,4)" \
    TEST.save_pth True \
    TEST.save_name ./train_output/data.pth \
    DATALOADER.TEST.BATCH_SIZE 16
done
...
do
    ...
    TEST.multi_scale "(2,3,4)" \
    TEST.save_pth True \
    TEST.save_name ./train_output/data_ema.pth \
    DATALOADER.TEST.BATCH_SIZE 16
done
